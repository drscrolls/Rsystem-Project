                                    ...
                                    <div class="col-lg-4">
                                        <div class="card hospital-info">
                                            <div class="card-body"> 
                                                ...
                                                <div class="media">
                                                    <div class="data-icon align-self-center">
                                                        <i class="fas fa-user-md rounded-circle text-info"></i>
                                                    </div>
                                                    <div class="media-body ml-3 align-self-center text-right"> 
                                                        <h3 class="mt-0">15</h3>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="card hospital-info">
                                            <div class="card-body"> 
                                                ...
                                                <div class="media">
                                                    <div class="data-icon align-self-center">
                                                        <i class="fas fa-user-nurse rounded-circle text-blue"></i>
                                                    </div>
                                                    <div class="media-body ml-3 align-self-center text-right"> 
                                                        <h3 class="mt-0">40</h3>
                                                        <p class="text-muted mb-0 text-nowrap">Today Available</p>                                                                                    
                                    ...
                                    <div class="col-lg-4">
                                        <div class="card hospital-info">
                                            <div class="card-body"> 
                                                ...
                                                <div class="media">
                                                    <div class="data-icon align-self-center">
                                                        <i class="fas fa-hand-holding-usd rounded-circle text-pink"></i>
                                                    </div>
                                                    <div class="media-body ml-3 align-self-center text-right"> 
                                ...
                                <div class="card">
                                    <div class="card-body"> 
                                        ...
                                        <div class="apexchart-wrapper">
                                            <div id="hospital_survey" class="chart-gutters"></div>
                                        </div>    
                                    </div><!--end card-body--> 
                                </div><!--end card-->
                            </div><!--end col-->
